...
const Drawer: React.FC<Props> = ({ isDrawerOpen }) => (
	<DrawerContainer padding={`${MainTheme.appBar.appBarHeight} 0 16px 0`} isDrawerOpen={isDrawerOpen}>
		<DrawerSection backgroundColor='transparent'>
			<DrawerButton textColor='white' fontWeight={300} href='/'>
				<Icon padding='24px 10px' margin={isDrawerOpen ? '0 16px 0 0' : ''}>
					<HomeIcon fontSize='medium' />
				</Icon>
				{isDrawerOpen ? 'Home' : ''}
			</DrawerButton>
			<DrawerButton textColor='white' fontWeight={300} href='/calendar'>
				<Icon padding='24px 10px' margin={isDrawerOpen ? '0 16px 0 0' : ''}>
					<CalendarIcon fontSize='medium' />
				</Icon>
				{isDrawerOpen ? 'Calendar' : ''}
			</DrawerButton>
			<DrawerButton textColor='white' fontWeight={300} href='/messages'>
				<Icon padding='24px 10px' margin={isDrawerOpen ? '0 16px 0 0' : ''}>
					<MessagesIcon fontSize='medium' />
				</Icon>
				{isDrawerOpen ? 'Messages' : ''}
			</DrawerButton>
			<DrawerButton textColor='white' fontWeight={300} href='/resources'>
				<Icon padding='24px 10px' margin={isDrawerOpen ? '0 16px 0 0' : ''}>
					<ResourcesIcon fontSize='medium' />
				</Icon>
				{isDrawerOpen ? 'Resources' : ''}
			</DrawerButton>
			<DrawerButton textColor='white' fontWeight={300} href='/classes'>
				<Icon padding='24px 10px' margin={isDrawerOpen ? '0 16px 0 0' : ''}>
					<ClassesIcon fontSize='medium' />
				</Icon>
				{isDrawerOpen ? 'Your Classes' : ''}
			</DrawerButton>
			<DrawerButton textColor='white' fontWeight={300} href='/units'>
				<Icon padding='24px 10px' margin={isDrawerOpen ? '0 16px 0 0' : ''}>
					<UnitsIcon fontSize='medium' />
				</Icon>
				{isDrawerOpen ? 'Your Units' : ''}
			</DrawerButton>
			<DrawerButton textColor='white' fontWeight={300} href='/grades'>
				<Icon padding='24px 10px' margin={isDrawerOpen ? '0 16px 0 0' : ''}>
					<GradesIcon fontSize='medium' />
				</Icon>
				{isDrawerOpen ? 'Your Grades' : ''}
			</DrawerButton>
			<DrawerButton textColor='white' fontWeight={300} href='/settings'>
				<Icon padding='24px 10px' margin={isDrawerOpen ? '0 16px 0 0' : ''}>
		...
		<DrawerSection backgroundColor='transparent'>
			{isDrawerOpen ? (
				<>
					<Divider color='light' />
					<DrawerSection backgroundColor='transparent' flexDirection='column' alignItems='flex-start' padding='0 24px'>
						{isDrawerOpen ? (
							<>
