...
const BackgroundGradientStyles = css<SectionContainerProps>`
	...
	background: linear-gradient(
		...
		${(props) => props.theme.getColor(props.gradientColor2 || 'secondary')} 55%,
		${(props) => props.theme.getColor(props.gradientColor3 || 'tertiary')} 80%
	);
`;
...
export const SectionContainer = styled.section<SectionContainerProps>`
  ...
  // Override padding
  padding: ${(props) => props.padding ?? '80px 160px'};
`;
